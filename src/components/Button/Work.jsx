...
import gif from '../../assets/images/Untitled video - Made with Clipchamp (1).gif'

const Work = () => {
  return (
    <div>
       <Gallery name="NFT Marketplace" link="https://medium.com/@anushapatil2208/nft-marketplace-ux-case-study-c2848f645254" category="Personal" image={gif} />
